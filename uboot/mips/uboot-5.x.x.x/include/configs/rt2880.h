...
#if defined(BOARD_TPLINK)
#if defined(TPLINK_FLASH_4M)
#define	CFG_FLASH_SIZE		0x400000
#define	CFG_ROMFILE_SIZE	0x0
#define	CFG_ROM_SIZE		0x0
#else
#define	CFG_FLASH_SIZE		0x800000
#define	CFG_ROMFILE_SIZE	0x10000
#define	CFG_ROM_SIZE		0x10000
#endif
#else
#define	CFG_ROMFILE_SIZE	0x00000
#define	CFG_ROM_SIZE		0x00000
#endif
